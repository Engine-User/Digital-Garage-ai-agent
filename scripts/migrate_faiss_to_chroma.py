...
Migrates:
  - Memory vectors: data/memory_vectors/ -> digital_garage_memories collection
  - RAG vectors:    data/rag/            -> digital_garage_rag collection
