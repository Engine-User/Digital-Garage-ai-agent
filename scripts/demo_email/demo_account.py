# Digital Garage@2026
#!/usr/bin/env python3
"""Create/remove the switchable, non-default 'Demo' EmailAccount in digital_garage.

Mirrors the existing local-Dovecot account (localhost:31143, STARTTLS) but points
at the throwaway demo@digital_garage.local mailbox. Password is stored Fernet-encrypted
...
NAME = "Demo"
IMAP_USER = "demo@digital_garage.local"
