...
function initMermaid() {
  if (!window.mermaid || window.__digital_garageMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__digital_garageMermaidReady = true;
}
window.oddigdigital_garageInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'digital_garage-thinking-expanded';
