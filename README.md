...
**Create AI agents, configure their behaviour, connect them into collaborative workflows — all from a self-hosted web UI.**
...
- **Chat** — Multi-turn chat with any local model or API (Huggingface, vLLM, llama.cpp, Ollama, OpenRouter, OpenAI)
