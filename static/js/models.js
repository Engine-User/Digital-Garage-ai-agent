...
const COLLAPSE_KEY = 'digital_garage-models-collapsed';
const FAVORITES_KEY = 'digital_garage-model-favorites';
const USAGE_KEY = 'digital_garage-model-usage';
const SORT_KEY = 'digital_garage-model-sort';
