 ...
 *    surfaces an action-toast that opens DYOM to fix.
 *
 * @param {{
 ...
 *   openDYOMForDependency:  (pkg: string) => void,
...
export function createApplyImageTool({
  ...
  openDYOMForDependency, openDYOMForImg2img,
