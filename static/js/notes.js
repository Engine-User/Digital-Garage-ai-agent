...
let _searchQuery = '';
let _viewMode = (typeof localStorage !== 'undefined' && localStorage.getItem('digital_garage-notes-view')) || 'list'; // 'list' or 'grid'
...
const REMINDER_FIRED_KEY = 'digital_garage-notes-reminder-fired';
...
const REMINDER_GLOWED_KEY = 'digital_garage-notes-reminder-glowed';
...
const REMINDER_PENDING_HIGHLIGHT_KEY = 'digital_garage-notes-reminder-pending-highlight';
const REMINDER_ACTIVE_HIGHLIGHT_KEY = 'digital_garage-notes-reminder-active-highlight';
...
const REMINDER_DISMISSED_AT_KEY = 'digital_garage-notes-reminder-dismissed-at';
const NOTES_FIRST_OPEN_HINT_KEY = 'digital_garage-notes-first-open-hint-v1';
...
export function openPanel() {
  ...
  if (viewBtn) {
    ...
    viewBtn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('digital_garage-notes-view', _viewMode); } catch { }
      pane.classList.toggle('notes-view-grid', _viewMode === 'grid');
      _setViewLabel();
      requestAnimationFrame(() => _applyMasonry(document.querySelector('#notes-pane .notes-pane-body')));
    });
...
const _DRAFT_PREFIX = 'digital_garage-note-draft-';
