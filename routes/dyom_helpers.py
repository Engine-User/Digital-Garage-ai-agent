# Digital Garage@2026
"""dyom_helpers.py — validators + small helpers shared by the dyom routes.
Extracted from dyom_routes.py; the routes module imports the symbols it needs."""
...
# Session IDs we mint look like "dyom-deadbeef" or "serve-deadbeef".
...
# The llama.cpp GGUF launcher (static/js/dyom.js) emits a fixed-shape
...
WIN_SESSION_DIR = "$env:TEMP\\\\Digital_Garage_sessions"
