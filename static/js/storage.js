...
// ── Key constants ──
export const KEYS = {
  THEME: 'digital_garage-theme',
  TOGGLES: 'digital_garage-toggles',
  ...
  MODELS_EXPANDED: 'digital_garage-model-expanded',
  MODEL_ENDPOINTS: 'digital_garage-model-endpoints',
  MODEL_SELECTED: 'digital_garage-selected-model',
  SORT_ORDER: 'digital_garage-sessions-sort',
  CHAT_SEARCH_SCOPE: 'digital_garage-search-scope',
  INCOGNITO: 'digital_garage-incognito',
  RAG_ACTIVE: 'digital_garage-rag-active',
  MCP_ACTIVE: 'digital_garage-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'digital_garage-density'
};
