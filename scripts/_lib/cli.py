# Digital Garage@2026
"""scripts/_lib/cli.py — shared scaffolding for the `digital_garage-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("digital_garage-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/digital_garage-foo`
...
VERSION = "0.1.0"  # bumped centrally; every digital_garage-* CLI reports this
