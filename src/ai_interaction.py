...
async def do_ui_control(content: str, session_id: Optional[str] = None) -> Dict:
    ...
    Actions:
      ...
      open_panel <name>       — Open a panel (documents, gallery, email, sessions, notes, memories, skills, settings, dyom)
    ...
    if action == "toggle":
        ...
        # email, sessions, notes, memories, skills, settings, dyom.
        ...
        if not target:
            return {"error": f"Unknown panel '{panel}'. Valid: documents, gallery, email, sessions, notes, memories, skills, settings, dyom."}
        return {
            "ui_event": "open_panel",
            "panel": target,
